...
has('act-image sits in the act-right column, above the Book button (Figma card rebuild); now conditionally styled with a per-activity background-image, item.image undefined falls back to the plain grey placeholder', '/*#__PURE__*/React.createElement("div", {\n    className: "act-right"\n  }, /*#__PURE__*/React.createElement("div", {\n    className: "act-image",\n    style: item.image ? {\n      backgroundImage: "url(" + item.image + ")",\n      backgroundSize: "cover",\n      backgroundPosition: "center"\n    } : undefined\n  }), /*#__PURE__*/React.createElement("button", {\n    className: "act-book-btn"');
