...
// The photographer add-on and the booking-for-other block (29 Aug 2026
// BOOKING-FOR-OTHER) both reuse the "addon-group" CSS-hide-on-completion
// pattern, so this text now appears twice; disambiguated by what follows.
has('section 2 addon-group CSS-hide pattern used by both photographer add-on and booking-for-other (2 occurrences)', 'className: "addon-group",\n    style: {\n      display: section2Collapsed ? "none" : undefined\n    }\n  }', 2);
has('photographer add-on addon-group followed by the addon-title div', 'className: "addon-group",\n    style: {\n      display: section2Collapsed ? "none" : undefined\n    }\n  }, /*#__PURE__*/React.createElement("div", {\n    className: "addon-title"\n  }, t.addonTitle)');
has('booking-for-other addon-group followed directly by its own perm-row (no addon-title)', 'className: "addon-group",\n    style: {\n      display: section2Collapsed ? "none" : undefined\n    }\n  }, /*#__PURE__*/React.createElement("div", {\n    className: "perm-row addon-row",\n    onClick: () => setBookingForOther(v => !v)\n  }');
...
has('booking-for-other block gated on isRiding && riders.length > 0, rendered right after the photographer addon-group as a sibling', ')"))), isRiding && riders.length > 0 && /*#__PURE__*/React.createElement("div", {');
...
has('note block only rendered when bookingForOther is checked, reuses the weight-warning visual pattern', 'bookingForOther && /*#__PURE__*/React.createElement("div", {\n    className: "weight-warning"\n  }, /*#__PURE__*/React.createElement("div", {\n    className: "ww-header"\n  }, /*#__PURE__*/React.createElement("div", {\n    className: "ww-icon"\n  }, "⚠️"), /*#__PURE__*/React.createElement("div", {\n    className: "ww-body"\n  }, t.bookingForOtherNote)');
...
has('section 2 box closes right after the booking-for-other block (29 Aug 2026 BOOKING-FOR-OTHER, added as a sibling after the photographer addon-group), then the section-2 blocked-note, immediately before section 3\'s own top-level div begins', 't.bookingForOtherNote)))))), blockedSection === 2 && /*#__PURE__*/React.createElement("div", {\n    className: "blocked-note"\n  }, /*#__PURE__*/React.createElement("span", null, t.section2Blocked), /*#__PURE__*/React.createElement("button", {\n    className: "blocked-note-close",\n    type: "button",\n    onClick: () => setBlockedSection(null)\n  }, "✕")), screen === "riders" && /*#__PURE__*/React.createElement("div", {\n    className: "step2-section-box fu step2-block"');
