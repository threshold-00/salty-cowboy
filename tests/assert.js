...
has('handleSend / buildWhatsAppMessage payload fields: totalPriceStr from Ro\'s earlier request, photographerTier -> photographerAddon from the 29 Aug 2026 auto-match redesign, every other field unchanged', 'const message = buildWhatsAppMessage({\n      actObj,\n      durationLabel: duration,\n      formattedDates,\n      isCourse,\n      selectedTime,\n      numPeople,\n      riders,\n      showWeight,\n      notes,\n      photographerAddon: isPhotoshoot ? photographerAddon : false,\n      grooming: needsGrooming ? grooming : null,\n      totalPriceStr\n    });');
...
has('section 2 box closes right after addon-group, then the section-2 blocked-note, immediately before section 3\'s own top-level div begins (section 3 now always renders, batch 7: section 3 accordion; one fewer closing paren than before since the 29 Aug 2026 photographer redesign removed the addonTiers.map() level)', '")"))))), blockedSection === 2 && /*#__PURE__*/React.createElement("div", {\n    className: "blocked-note"\n  }, /*#__PURE__*/React.createElement("span", null, t.section2Blocked), /*#__PURE__*/React.createElement("button", {\n    className: "blocked-note-close",\n    type: "button",\n    onClick: () => setBlockedSection(null)\n  }, "✕")), screen === "riders" && /*#__PURE__*/React.createElement("div", {\n    className: "step2-section-box fu step2-block"');
