...
has('section 2 box closes right after addon-group, immediately before section 3\'s own top-level div begins (section 3 now always renders, batch 7: section 3 accordion)', '")")))))), screen === "riders" && /*#__PURE__*/React.createElement("div", {\n    className: "step2-section-box fu step2-block"');
...
has('section3ManualCollapse state added alongside the existing section1/2ManualOpen hooks', 'const [section3ManualCollapse, setSection3ManualCollapse] = useState(false);');
has('section3Collapsed is collapsed whenever dates aren\'t complete yet (no manual override pre-datesComplete), or manually collapsed after the fact', 'const section3Collapsed = !datesComplete || section3ManualCollapse;');
has('section 3 heading only becomes clickable/gets a chevron once datesComplete, mirroring sections 1/2\'s "clickable once complete" pattern', 'className: "section-title" + (datesComplete ? " section-title-toggle" : ""),\n    onClick: datesComplete ? () => setSection3ManualCollapse(o => !o) : undefined\n  }, t.stepHeading3, datesComplete && /*#__PURE__*/React.createElement("span", {\n    className: "section-toggle-arrow"\n  }, section3Collapsed ? "▾" : "▴")');
has('section 3 collapsed hint shows a static "complete the steps above" placeholder before datesComplete, or the total price if manually collapsed afterward', 'section3Collapsed && /*#__PURE__*/React.createElement("p", {\n    className: "section-hint",\n    style: {\n      cursor: datesComplete ? "pointer" : undefined\n    },\n    onClick: datesComplete ? () => setSection3ManualCollapse(o => !o) : undefined\n  }, datesComplete ? (totalPriceStr ? t.totalCostLabel + ": " + totalPriceStr : t.stepHeading3) : t.summaryPendingHint)');
