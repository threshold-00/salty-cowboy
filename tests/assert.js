...
has('gallery-row (4 placeholder thumbnails) renders for isPhotoshoot activities only, right where the image band used to sit', 'isPhotoshoot && /*#__PURE__*/React.createElement("div", {\n    className: "gallery-row"\n  }, [0, 1, 2, 3].map(i => /*#__PURE__*/React.createElement("div", {\n    key: i,\n    className: "gallery-thumb"\n  })))');
...
has('.gallery-thumb reuses --fog (same placeholder fill as .detail-header-image) and the page\'s existing 14px border-radius, no new tokens introduced', '.gallery-thumb {\n  flex: 1;\n  aspect-ratio: 1;\n  background: var(--fog);\n  border-radius: 14px;\n}');
