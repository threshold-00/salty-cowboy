...
has('booking-for-other gated on isRiding && riders.length > 0, dropping the screen === "riders" half it needed as a standalone card, since section 2 is already inside a screen === "riders" block (10 Sep 2026 CHECKBOXES-UNDER-WHOS-COMING)', '}), isRiding && riders.length > 0 && /*#__PURE__*/React.createElement("div", {\n    className: "addon-group"');
